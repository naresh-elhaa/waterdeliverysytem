      ...
      <div>
         <div class="row">
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{ route('modal_store') }}" method="Post">
                         @csrf
                           <div class="row">
                                <div class="bd-example">
                                        <div class="form-floating custom-form-floating custom-form-floating-sm form-group col-md-6 mb-3">
                                        
                                            <input type="text" name="modal_name" class="form-control"  id="floatingInput"  placeholder="Place Holder">
                                            <label for="floatingInput">{{ __('view.model_name') }}</label>
                                        </div>
                                        <div class="form-floating custom-form-floating custom-form-floating-sm form-group col-md-6 mb-3">
                                            
                                            <input type="text" name="seating_capacity" class="form-control" id="floatingInput"  placeholder="Place Holder">
                                            <label for="floatingInput">{{ __('view.seating_capacity') }}</label>
                                        </div>

                                        <div class="form-floating custom-form-floating custom-form-floating-sm form-group col-md-6 mb-3">
                                        
                                            <input type="text" name="length" class="form-control"  id="floatingInput"  placeholder="Place Holder">
                                            <label for="floatingInput">{{ __('view.length') }}</label>
                                        </div>
                                        <div class="form-floating custom-form-floating custom-form-floating-sm form-group col-md-6 mb-3">
                                            
                                            <input type="text"  name="width" class="form-control" id="floatingInput"  placeholder="Place Holder">
                                        ...
                                        <div class="form-floating custom-form-floating custom-form-floating-sm form-group col-md-6 mb-3">
                                            ...
                                            <input type="text" name="delivery_support" class="form-control"  id="floatingInput"  placeholder="Place Holder">
                                            <label for="floatingInput">{{ __('view.delivery_support') }}</label>
                                        </div>
                                        <div class="form-floating custom-form-floating custom-form-floating-sm form-group col-md-6 mb-3">
                                            
                                            <input type="text"  name="delivery_price" class="form-control" id="floatingInput"  placeholder="Place Holder">
                                        ...
                                        <div class="form-floating custom-form-floating custom-form-floating-sm form-group col-md-6 mb-3">
                                            ...
                                            <input type="text" name="maximum_capacity" class="form-control"  id="floatingInput"  placeholder="Place Holder">
