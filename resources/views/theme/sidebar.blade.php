<aside class="sidebar sidebar-default navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <!--logo End-->            <h6 class="logo-title">{{appName()}}</h6>
            </a>
                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
                            ...
                            <span class="item-name">Ai.Fleet</span>
                            <i class="right-icon">
                        ...
                        @if(!auth()->user()->can('model_index'))
                            <li class="nav-item">
                                <a class="nav-link " href="{{ route('modal_index') }}">
                                  ...
                                  <span class="item-name"> {{ __('view.model') }} </span>
                                </a>
                            </li>
                        @endif
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="">
                                    ...
                                    <span class="item-name">{{ __('view.vehicles') }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="">
                                    ...
                                    <span class="item-name"> {{ __('view.assigned_vehicles') }}</span>
                                </a>
                            </li>
